  ...
  return (
    <div className="space-y-[30px] flex-[0.5] p-[50px_100px_50px_50px]">
        ...
        <ul className="list-outside pl-6 space-y-1">
            <li className="text-[#333333] marker:text-[#8ed1fc] font-[400] text-[22px] leading-[32px] list-disc ">Identify customers instantly and surface critical details through AI-driven caller recognition.</li>
            <li className="text-[#333333] marker:text-[#8ed1fc] font-[400] text-[22px] leading-[32px] list-disc ">Eliminates manual lookups and summarizes relevant information from CRMs, past tickets, interaction history, and more.</li>
        </ul>
        <div className="flex">
