      ...
      <div className="flex flex-col space-y-5 justify-center items-center container px-[5rem]">
        <div className="flex flex-col justify-center  md:mb-[75px]  mb-[45px] items-center">
          <Image
            ...
            priority="true"
          ></Image>
          <h1 className="lg:text-[4.125rem] text-[38px] lg:leading-[74px] text-center  leading-[44px]  font-semibold lg:font-bold">
            Your AI Copilot for the<br className="lg:block hidden "></br> Entire
            Call Journey
          </h1>
          ...
          <div className="lg:text-[18px] font-extralight flex text-gray-400">
            powered by{" "}
            <span className="font-bold text-[#000] uppercase flex">
              <Image
                src={"/images/logo.png"}
        ...
        <div className="flex flex-col lg:flex-row  lg:gap-[4rem] gap-[3rem] justify-between ">
          <div className=" w-full px-[15px] flex flex-col space-y-4">
            ...
            <p className="lg:text-[20px] text-center font-[300]">
              Our AI Copilot gets a head start by mining relevant CRM data,
              previous requests, historical interactions and more before the
              first hello. Agents receive a panoramic customer view to hit the
              ground running.
            </p>
          </div>
          <div className="w-full px-[15px]  flex flex-col space-y-4">
            ...
            <p className="lg:text-[20px] text-center font-[300]">
              No more app switching or silo scrambling for your agents. AI
              Copilot dynamically serves up the knowledge and responses they
              need, in lockstep with the conversation flow.
            </p>
          </div>
          <div className="w-full px-[15px]  flex flex-col space-y-4 ">
            ...
            <p className="lg:text-[20px] text-center font-[300]">
              Our AI Copilot ensures your agents make the most of their valuable
              time by reducing administrative burdens. Energize your customer
              service through the dual benefits of robust documentation and
              liberated employee focus.
            </p>
          </div>
        </div>
      </div>
