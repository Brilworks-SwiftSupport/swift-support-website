...
const BlogContactForm = () => {
  ...
  return (
    <div className="blog-form w-full sticky top-[110px] mb-6 overflow-auto lg:max-h-[calc(100vh_-_110px)] p-4">
      <div className="mt-1 mb-4">
        <p className="text-2xl font-medium text-colorDarkBlue">Get In Touch</p>
      </div>
      ...
      <form id="Blogpage-contact-form" onSubmit={handleSubmit}>
        ...
        <div className="mb-4 !text-xs !font-[unset]" id="sucess_msg">
          {respMessage}
        </div>

        <button
          className="rounded-lg border-2 border-colorBlack bg-colorBlack text-colorWhite hover:bg-colorWhite hover:text-colorBlack font-bold text-lg py-[6px] !w-full"
          type="submit"
