    ...
    <main className="flex mt-32 justify-center">
      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div>
          ...
          <p className="text-4xl md:text-5xl font-bold mb-5 w-full max-w-[80%] mx-auto font-Urbanist text-[54px]">Bring Text to Life with Realistic Voices.</p>
          ...
          Convert text into high-quality, <span className="bg-clip-text text-transparent bg-text-theme-gradient"> Natural-sounding Audio</span> in seconds.
          </p>
        </div>
          ...
          <div className="mb-3 mt-3">
            ...
            >
              ...
              <div className="relative items-center p-4  max-w-[100%] mx-auto">
                ...
                className={`absolute rounded rounded-md w-[120px] h-[30px] bottom-2 right-2 ${
                  inputText.trim()
        ...
        <div className="text-center border border-gray-300 rounded-md mt-5 h-[200px] p-4 max-w-[100%] mx-auto mb-2">
              ...
              <div className="relative items-center p-4  max-w-[100%] mx-auto mt-4">
                ...
                <button
                  ...
                  className={`absolute rounded rounded-md w-[125px] h-[30px] bottom-2 right-2 bg-black cursor-pointer text-white`}
